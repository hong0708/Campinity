...
@NoArgsConstructor
@AllArgsConstructor
public class ReqCampsiteImageDto {
    ...
    public MultiValueMap<String, String> toMultiValueMap(int numOfRows, String serviceKey, int contentId) throws UnsupportedEncodingException {
        ...
        map.add(URLEncoder.encode("contentId", "UTF-8"), URLEncoder.encode(String.valueOf(contentId), "UTF-8"));
