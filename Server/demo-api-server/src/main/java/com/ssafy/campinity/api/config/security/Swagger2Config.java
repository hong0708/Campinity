...
public class Swagger2Config {
    ...
    private static final String API_NAME = "Campinity API";
    private static final String API_VERSION = "1.0";
    private static final String API_DESCRIPTION = "Campinity API 문서";
...
//                .produces(getProduceContentTypes())
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ssafy.campinity"))
