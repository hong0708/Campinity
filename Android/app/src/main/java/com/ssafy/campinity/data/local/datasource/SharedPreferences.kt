...
class SharedPreferences(context: Context) {
    ...
    var isUserInCommunity: String?
        get() = prefs.getString("isUserInCommunity", null)
        set(value) = prefs.edit().putString("isUserInCommunity", value).apply()

    var isUserInSearch: String?
