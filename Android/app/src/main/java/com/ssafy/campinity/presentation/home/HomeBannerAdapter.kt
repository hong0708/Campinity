...
class HomeBannerAdapter(private val datas: ArrayList<HomeBanner>) : RecyclerView.Adapter<BannerViewHolder>() {

    lateinit var binding: ItemHomeBannerBinding

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BannerViewHolder {
        binding = DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.item_home_banner, parent, false)
